...
def train():
    config = Config()
    env = simple_adversary_v3.env(max_cycles=100)  # Make sure you have the environment installed
    ...
    plot_rewards = []
    time_step = 0
    for episode in range(args.episodes):  # Number of episodes
        ...
        for agent in env.agent_iter():
            ...
            if agent == "agent_1":
                ...
                # if temp_count == 10:
                #     return
                ############ the states and next states seems to be working.
                states = []
                next_states = []
                rewards = []
                actions = []
        ...
        print("episode length:", env.steps)
